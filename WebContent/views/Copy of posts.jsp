...
<c:forEach items="${posts}" var="post">
	<div class="panel panel-primary">
		<div class="panel panel-heading">
			<b>${post.title}</b> <span class="pull-right"><b>posted on
					${post.date}</b> &nbsp;by <b>${post.uname}</b></span>
		</div>
				...
				<div class="form-group">
					...
					<c:forEach items="${post.comments}" var="comment">
						...
						<div class="bg-warning">
							...
							<p style="padding-left: 600px; padding-bottom: 5px;">
					...
					<textarea rows="5" cols="75" name="comment" class="form-control "
